...
GMR_ROOT = PROJECT_ROOT / "gmr"
for path in (PROJECT_ROOT, GMR_ROOT):
    if str(path) not in sys.path:
        sys.path.insert(0, str(path))

from gmr.general_motion_retargeting import GeneralMotionRetargeting as GMR
from gmr.general_motion_retargeting import RobotMotionViewer
from gmr.general_motion_retargeting.utils.smpl import load_smplx_file, get_smplx_data_offline_fast
from gmr.general_motion_retargeting.kinematics_model import KinematicsModel
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--robot",
        choices=["unitree_g1", "unitree_g1_23dof", "unitree_g1_with_hands", "unitree_h1", "unitree_h1_2",
    ...
    SMPLX_FOLDER = PROJECT_ROOT / "assets" / "body_models"
